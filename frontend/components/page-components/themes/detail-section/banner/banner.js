    ...
    <>
      <div
        style={{
          ...
          overflow: 'hidden',
          background: `linear-gradient(to top, black, rgba(155, 155, 155, 0)), url("/themes-main/${themeImg}") no-repeat center center`,
      ...
      >
        <div className="container">
          <div className="row">
            <div className="col-6">
              <h1 className={myStyle.h1}>{themeName}</h1>
              <p className={myStyle.p}>{theme_desc}</p>
      ...
      <BasicModal02
        ...
        modalBody={
          <div>
            ...
            <p>
              8.
              如因年齡未達遊戲主題限制，本工作室有權拒絕玩家入場，且不得將未成年孩童託管在場館內。如有特殊需求（嬰兒車、寵物等），請先來電詢問。
            </p>
